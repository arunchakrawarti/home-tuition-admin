...
export const CategoryLayout = ({ children, params }) => {
  const tabs = [
    { route: "/categories/main-category", label: "Main Category" },
    { route: "/categories/sub-category", label: "Sub Category" },
    { route: "/categories/child-category", label: "Child Category" },
  ];
